...
###Do not edit this file if you don't understand how it works.###
...
from dictionary import item_id_dictionary #We import this to Used to manage identity items in the game
from dictionary import npc_id_dictionary #We import this to Used to manage the identity of the NPC in the game.
...
class EntityManager:
    ...
    def name_to_player_slot(self, _name):
        try:
            slots = [slot for slot, player in self.players.items() if player.name == _name]
            return slots
        except:
    ...
    def return_all_player_slots(self):
       try:
    ...
    def return_all_item_slots(self):
       try:
    ...
    def find_id_by_name(self,name, constants_dict):
        id = constants_dict[name]
...
class Bot:
    ...
    async def sendMsg(self,text):
        ...
        await self.packet_manager.add_packet(packet)
    async def summonItems(self,item_slot,pos_x,pos_y,vel_x,vel_y,stack_amount,item_id):
